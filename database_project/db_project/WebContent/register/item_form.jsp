...
<div><a href='register.jsp'><img src='../image/hero.jpg' width="300" height="100" ></a></div>
	<form name="itemForm" method="post" action="item_register.jsp">
	<h3>등록할 아이템의 정보를 입력하시오.</h3>
	<table border="1" cellpadding="3" cellspacing="0">
	
		<tr>
			<td>아이템명</td>
			<td><input type="text" name="new_item" size="30" ></td>
		</tr>
		...
		<tr>
			<td>공격력 증가량</td>
			<td><input type="text" name="attack_p_up" size="5" ></td>
		</tr>
		<tr>
			<td>방어력 증가량</td>
			<td><input type="text" name="defend_p_up" size="5" ></td>
		</tr>
		<tr>
			<td>힘 증가량</td>
			<td><input type="text" name="str_up" size="5" ></td>
		</tr>
		<tr>
			<td>지능 증가량</td>
			<td><input type="text" name="int_up" size="5" ></td>
		</tr>
		<tr>
			<td colspan="2" align="center">
				<input type="submit" value="아이템등록">
